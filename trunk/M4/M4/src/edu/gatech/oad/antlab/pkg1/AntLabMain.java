 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  toPrint += p1.toString("9933378");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Zhiyuan Lin");
		  toPrint += p2.toString("902932928");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Steven Han");
		  toPrint += p3.toString("shan304");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Allen Tsai");
          toPrint += p4.toString("902918315");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Wataru");
          toPrint += p5.toString("902937699");
